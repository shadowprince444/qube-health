...
import 'package:qubehealth/app/utils/screen_utils/ui_utils.dart';
...
//endregion
  ...
  static double getVerticalSize(double height) {
    return (height / 8.96) * _heightMultiplier;
  }

  static double getHorizontalSize(double width) {
    return (width / 4.14) * _widthMultiplier;
  }

  static double getTextSize(double textSize) {
    return (textSize / 8.96) * _textMultiplier;
  }
